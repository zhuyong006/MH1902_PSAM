...
#define MH_TRNG_RNG_AMA_PD_TRNG0_Pos					(30)
#define MH_TRNG_RNG_AMA_PD_TRNG0_Mask					(0x01U<<MH_TRNG_RNG_AMA_PD_TRNG0_Pos) 
...
{
	MH_TRNG->RNG_CSR |= 0x10;	//Ê¹ÄÜÖÐ¶Ï
	MH_TRNG->RNG_AMA &= ~MH_TRNG_RNG_AMA_PD_TRNG0_Mask;
