...
void mh_sha1_starts(sha1_context *ctx);
void mh_sha1_update(sha1_context *ctx,const uint8_t *input,uint32_t i_len);
void mh_sha1_finish(sha1_context *ctx,uint8_t digest[20]);

void mh_sha256_starts(sha2_context *ctx);
void mh_sha256_update(sha2_context *ctx,const uint8_t *input,uint32_t i_len);
void mh_sha256_finish(sha2_context *ctx,uint8_t digest[32]);
