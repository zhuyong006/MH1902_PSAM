...
#define MH_RET_CRYPT_FUNCTION_ID_ERR            (('R'<<24)|('F'<<16)|('I'<<8)|('E'))
#define MH_RET_CRYPT_LENGTH_ERR                 (('R'<<24)|('O'<<16)|('L'<<8)|('E'))
#define MH_RET_CRYPT_SUCCESS                    (('R'<<24)|('C'<<16)|('S'<<8)|('U'))
#define MH_RET_GCD_ISNOT_ONE                    (('R'<<24)|('G'<<16)|('I'<<8)|('O'))
    
#define MH_RET_PARAM_ERR                        (('R'<<24)|('P'<<16)|('A'<<8)|('E'))    
...
uint32_t bn_add(uint32_t *r,uint32_t *a,uint32_t *b,uint32_t len);
uint32_t bn_sub(uint32_t *r,uint32_t *a,uint32_t *b,uint32_t len);
uint32_t bn_add_int(uint32_t *r,uint32_t *a,uint32_t b,uint32_t len);
uint32_t bn_sub_int(uint32_t *r,uint32_t *a,uint32_t b,uint32_t len);
void bn_modadd(uint32_t *r,uint32_t *a,uint32_t *b,uint32_t *p,uint32_t len);
void bn_modsub(uint32_t *r,uint32_t *a,uint32_t *b,uint32_t *p,uint32_t len);
